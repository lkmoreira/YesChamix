...
import br.com.gv8.yeschamix.activity.adapter.FileArrayAdapter;
import br.com.gv8.yeschamix.util.Option;
...
public class FileChooserActivity extends ListActivity{
	...
	public void onCreate( Bundle savedInstanceState ) {
		...
		dialogo( "Configuração do Xml", "Por favor, selecione o arquivo de configuração." );
		file = new File( "" );
...
//					preferences.setCaminhoPasta( new String( original ) );
			...
			preferences.save();		
			Toast.makeText( this, "Yes Turbo configurado com sucesso. Faça a sincronização.", Toast.LENGTH_SHORT ).show();
		} catch ( Exception e ) {
