...
public class ImageLoader extends Thread {
     ...
     */
    public synchronized void queueImageLoad(final Bitmap lBitmap,
	    final ImageView aImageView, final ViewSwitcher aViewSwitcher) {
	...
	handler.post(new Runnable() {
		...
		try {
			...
			// Bitmap lBitmap = BitmapFactory.decodeFile(aPath,
			// lOptions);
     ...
     */
    private void signalUI(ViewSwitcher aViewSwitcher, ImageView aImageView,
	    Bitmap aImage) {
